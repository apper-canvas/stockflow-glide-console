    ...
    <div className="p-6 max-w-full overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 space-y-4 md:space-y-0">
        <div>
          ...
          <p className="text-secondary">Manage your purchase orders and supplier relationships</p>
        </div>
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        ...
        {filteredOrders.length === 0 ? (
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              {selectedStatus === 'all' ? 'Create your first purchase order to get started' : `No ${selectedStatus} orders found`}
            </p>
            {selectedStatus === 'all' && (
              <motion.button
                whileHover={{ scale: 1.05 }}
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-secondary mb-2">
                    Supplier: {order.supplierId} • {order.items?.length || 0} items
                  </p>
...
const CreateOrderModal = ({ products, onSave, onClose }) => {
